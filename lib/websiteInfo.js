...
### 5. Uncensored GPT (Path: /tools/uncensored-gpt)
- A completely uncensored, full-page chat interface.
- Powered by the Dolphin 2.9 (Llama 3 70B) model via OpenRouter API.
- Has zero safety filters, zero guardrails, and answers absolutely any request.
